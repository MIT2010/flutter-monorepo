...
import 'package:authentication/src/presentation/cubit/auth_cubit.dart' as _i515;
import 'package:authentication/src/presentation/cubit/auth_session_adapter.dart'
    as _i344;
...
class AuthenticationPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.lazySingleton<_i279.AuthRepository>(
      () => _i556.AuthRepositoryImpl(
        gh<_i398.AuthRemoteDataSource>(),
        gh<_i53.SecureTokenStorage>(),
      ),
    );
    gh.factory<_i651.LoginUseCase>(
      () => _i651.LoginUseCase(
        gh<_i279.AuthRepository>(),
        gh<_i811.AnalyticsService>(),
      ),
    );
    gh.lazySingleton<_i515.AuthCubit>(
      () => _i515.AuthCubit(gh<_i279.AuthRepository>()),
    );
    gh.lazySingleton<_i811.AuthSession>(
      () => _i344.AuthSessionAdapter(gh<_i515.AuthCubit>()),
    );
    gh.factory<_i689.LoginCubit>(
      () => _i689.LoginCubit(gh<_i651.LoginUseCase>(), gh<_i515.AuthCubit>()),
    );
  }
}
