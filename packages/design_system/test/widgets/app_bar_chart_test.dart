...
void main() {
  group('AppBarChart', () {
        ...
        MaterialApp(
          ...
          home: Scaffold(
            body: AppBarChart(
              ...
              series: const [
                AppChartSeries(label: 'Revenue', values: [10, 20, 15]),
              ],
            ),
          ),
        ),
    ...
    testWidgets('renders with an empty series list without throwing', (
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: AppTheme.light(),
          home: const Scaffold(
            body: AppBarChart(categories: ['Jan', 'Feb'], series: []),
          ),
        ),
      );
      await tester.pump(const Duration(milliseconds: 250));
    ...
    testWidgets('respects disableAnimations -- bars appear instantly', (
      tester,
    ) async {
      ...
      // when the growth animation duration collapses to zero.
      await tester.pump();
